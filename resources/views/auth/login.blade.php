                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Foreign Management System</h5>
                                    <p class="text-muted">Provide your login credentials to use the system</p>
                                    @if (session('status'))
                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="{{ url('password/reset') }}" class="active">Forgot password?</a>
                                            </div>
