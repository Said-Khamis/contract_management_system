                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Enter new password to continue...</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">FMS</h5>
                                    <p class="text-muted">Please enter your new password before continuing</p>
                                </div>
