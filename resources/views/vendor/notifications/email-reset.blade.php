    ...
    <tr>
        <td style="padding: 20px;">
            ...
            <p style="text-align: center;">
                <a href="[Reset Link]" style="display: inline-block; padding: 10px 20px; background-color: #007bff; color: #fff; text-decoration: none; border-radius: 5px;">Reset Password</a>
            </p>
