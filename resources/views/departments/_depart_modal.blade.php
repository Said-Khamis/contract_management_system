...
<div class="modal fade" id="departModal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="departLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="formDepart" enctype="multipart/form-data">
                    {{ csrf_field() }}
