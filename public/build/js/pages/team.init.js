                        ...
                        <div class="col-lg-4 col">\
                            <div class="team-profile-img">\
                                ...
                                <div class="team-content">\
                                    ...
                                    <p class="text-muted member-designations mb-0">'+teamData.position+'</p>\
                                </div>\
                            </div>\
                        </div>\
                        <div class="col-lg-4 col">\
        ...
        elem.addEventListener('click', function (event) {
            ...
            allmemberlist = allmemberlist.map(function (item) {
                if (item.id == getEditid) {
                    ...
                    document.getElementById('designations').value = item.position;
        ...
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    var inputDesignation = document.getElementById('designations').value;
...
function memberDetailShow() {
    Array.from(document.querySelectorAll(".team-box")).forEach(function (item) {
        item.querySelector(".member-name").addEventListener("click", function () {
            ...
            var memberDesignation = item.querySelector(".member-designations").innerHTML;
            ...
            document.querySelector("#member-overview .profile-designations").innerHTML = memberDesignation;
